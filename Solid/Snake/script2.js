...
function movement() {
	...
	if(!flag)setTimeout("movement()",Stage<23?speeds[Stage]:30);
	else
	{	if(flag==1)
		{	totalpoints+=snk1.points*10+((Stage-1)*6);
			$('menu').innerHTML="Game finish.<br>"+"Did "+snk1.points+" points.<br><br>"+"<input type=button value=Start onclick='gameStart();'>";
			Stage=0;
			totalpoints=0;
		}
		else
...
var snk1=new snakes('#333');
var Food;
var Stage=0;
var speeds=[220,200,180,165,150,140,130,120,110,100,95,90,85,80,75,70,65,60,55,50,45,40,35];
var totalpoints=0;